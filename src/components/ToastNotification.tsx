...
export default function ToastNotification({
  ...
  subText = 'We think you should check it',
  tone,
  onClose,
  ...
  return (
    <div className="toast-stack" role="status" aria-live="polite">
      <div className={`toast-card toast-card--${resolvedTone}`}>
        <svg className="toast-card__wave" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="toast-card__message-container">
          <p className="toast-card__message">{message}</p>
          <p className="toast-card__subtext">{subText}</p>
        </div>
        <svg 
